...
II!](https://github.com/danilofreire/qtm151) This website contains links to all
the materials for the course, including lectures, assignments, quizzes, and
tutorials.
...
The [`tutorials/`](tutorials/tutorials.qmd)
folder contains step-by-step guides for various tools and techniques used in
the course. These include:

- [VSCode and Anaconda Tutorial](tutorials/01-vscode-anaconda-tutorial.qmd)
- [Jupyter Notebook and Markdown Tutorial](tutorials/02-jupyter-markdown-tutorial.qmd)
- [GitHub Tutorial](tutorials/03-github-tutorial.qmd)
- [PostgreSQL Tutorial](tutorials/04-postgresql-tutorial.qmd)
...
- Software: [Anaconda distribution of Python 3.x](https://www.anaconda.com/),
  ...
  [PostgreSQL](https://www.postgresql.org/), and [GitHub Desktop](https://github.com/apps/desktop)
